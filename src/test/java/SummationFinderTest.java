...
class SummationFinderTest {
    ...
    public void verifySum() {
        ...
        assertEquals(0, summationFinder.findNumberBySum(new int[]{3, 4, 5, 6}, 1));
        assertEquals(1, summationFinder.findNumberBySum(new int[]{0, 15, 32, 2000, 15000}, 15));
        assertEquals(2, summationFinder.findNumberBySum(new int[]{1, 1, 10, 32, 41}, 42));
    }
}